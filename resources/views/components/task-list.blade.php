...
<div class="mt-4 w-full max-w-md mx-auto p-4 bg-white shadow rounded" x-data="{
    ...
    @foreach($tasks as $task)
        <div class="relative mb-4" wire:loading.class="opacity-50 pointer-events-none">
    ...
    @if (!$tasks->count())
        <div wire:loading.class="opacity-50 pointer-events-none">No Tasks created yet.</div>
    @endif
